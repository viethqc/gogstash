...
func Test_ConsoleErrorFormatter(t *testing.T) {
	...
	testDataPool := []struct {
		...
		},
		{
			...
			"github.com/viethqc/gogstash/KDGoLib/errutil/ConsoleFormatter_test.go lasterror",
			false,
			"LongFile",
		},
		{
		...
		},
		{
			...
			"github.com/viethqc/gogstash/KDGoLib/errutil/ConsoleFormatter_test.go lasterror; childerror1; childerror2",
			false,
			"Seperator|LongFile",
		},
		{
		...
		},
		{
			...
			"github.com/viethqc/gogstash/KDGoLib/errutil/ConsoleFormatter_test.go:19 lasterror; childerror1; childerror2",
			false,
